...
public class CallBankNegativeTest {
    ...
    @Test
    void shouldBefailedLatinNameInput() {
        driver.findElement(By.xpath("//span[@data-test-id='name']//input"))
                .sendKeys("Ivan");
        driver.findElement(By.xpath("//span[@data-test-id='phone']//input"))
                .sendKeys("+79998888888");
    ...
    @Test
    public  void  shouldBeFailedUncheckbox() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Ив Иван");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79998888888");
        driver.findElement(By.cssSelector("button.button")).click();
